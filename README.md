...
"Math magicians" is a web project maden with the React framework. The project also utilizes an API to fetch and display data on the page. This website is for all fans of mathematics. It is a Single Page App (SPA) that allows users to:
...
- git clone git@github.com:sanieni6/Leaderboard.git
- cd Leaderboard
